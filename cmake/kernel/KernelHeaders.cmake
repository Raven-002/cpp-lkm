...
# Expose kernel header search paths/defines to CMake C++ targets so IDE diagnostics
# match kbuild's compile context (without requiring .ko builds).
...
if(EXISTS "${CPP_LKM_KERNEL_BUILD_DIR}/Makefile")
    ...
    message(
        STATUS
            "Kernel build dir not found at '${CPP_LKM_KERNEL_BUILD_DIR}';"
...
target_compile_definitions(cpp-lkm-kernel-headers INTERFACE __KERNEL__ MODULE KBUILD_MODNAME=\"cpp_lkm\")
